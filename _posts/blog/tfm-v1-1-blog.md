...
Log](https://ci.trustedfirmware.org/view/TF-M/job/tf-m-nightly/lastStableBuild/artifact/docs/trusted-firmware-m/build/install/doc/user_guide/html/docs/reference/changelog.html)
...
process](https://ci.trustedfirmware.org/view/TF-M/job/tf-m-nightly/lastStableBuild/artifact/docs/trusted-firmware-m/build/install/doc/user_guide/html/docs/contributing/release_process.html)
...
TF-M v1.1 includes support for [Profile
Small](https://ci.trustedfirmware.org/view/TF-M/job/tf-m-nightly/lastStableBuild/artifact/docs/trusted-firmware-m/build/install/doc/user_guide/html/docs/design_documents/tfm_profile_small.html)
aimed at memory constrained devices meeting requirements for PSA
Certified Level 1. Profile Medium is in the works.
...
TF-M](https://ci.trustedfirmware.org/view/TF-M/job/tf-m-nightly/lastStableBuild/artifact/docs/trusted-firmware-m/build/install/doc/user_guide/html/index.html).
...
-   TF-M till recently supported Arm Compiler and GCC. With TF-M v1.1,
    ...
    found
    [here](https://ci.trustedfirmware.org/view/TF-M/job/tf-m-nightly/lastStableBuild/artifact/docs/trusted-firmware-m/build/install/doc/user_guide/html/docs/getting_started/tfm_build_instruction_iar.html)
