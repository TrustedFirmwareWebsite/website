      ...
      - component: collapse
        ...
        panels:
          - title: Where can I start looking at project documentation and code?
            content: |
              The best place to start is the [TrustedFirmware github](https://github.com/TrustedFirmware) which links to all the documentation and projects. Projects are also described on the website under their relative, clickable, project tiles on the [homepage](https://www.trustedfirmware.org/).
